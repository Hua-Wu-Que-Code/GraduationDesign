    ...
    >
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag
            class="Pet"
            disable-transitions>{{scope.row.clinic.name}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        label="状态"
        ...
        <template slot-scope="scope">
          <el-tag
            ...
            disable-transitions>{{scope.row.doctor.statusStr}}</el-tag>
        </template>
      </el-table-column>
...
import {fetchDoctorList} from "@/api/doctor"; // secondary package based on el-pagination
