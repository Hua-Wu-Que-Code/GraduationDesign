...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      this.listQuery = this.OrignalListQuery;
      this.getList()
    },
    searchExam() {
    ...
    handleEdit(row) {
      console.log(row)
      let playLoad = {}
      playLoad.healthrecord = row.userInfo.healthrecord;
      playLoad.healthCareInfo = this.healthCareInfo
      this.$router.push({path:'/doctorHealthRecord/info' , query: {playLoad: playLoad}});
    },
    handleDelete(row) {
      console.log(row.id)
