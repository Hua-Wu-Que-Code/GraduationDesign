...
public class RabbitMQConfig {
    ...
    //队列名称
    public   final static String orderQueue = "user.order.delay_exchange";
    ...
    public Queue orderQueue() {
        ...
        return new Queue(RabbitMQConfig.orderQueue, true, false, false, args);
    }

    //声明一个direct类型的交换机
    @Bean
    DirectExchange orderExchange() {
        return new DirectExchange(RabbitMQConfig.orderExchange);
    }
